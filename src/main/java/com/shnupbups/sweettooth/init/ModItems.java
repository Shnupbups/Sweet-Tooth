...
public class ModItems {
	...
	public static Item CARAMEL_APPLE = new FoodOnAStickItem(new Item.Settings().recipeRemainder(Items.STICK).group(ItemGroup.FOOD).maxCount(64).food(new FoodComponent.Builder().hunger(4).saturationModifier(0.4f).build()));
	public static Item TOFFY_APPLE = new FoodOnAStickItem(new Item.Settings().recipeRemainder(Items.STICK).group(ItemGroup.FOOD).maxCount(64).food(new FoodComponent.Builder().hunger(4).saturationModifier(0.4f).build()));
	public static Item CHILLED_TOFFY_APPLE = new FoodOnAStickItem(new Item.Settings().recipeRemainder(Items.STICK).group(ItemGroup.FOOD).maxCount(64).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 300, 0),1f).alwaysEdible().build()));
	public static Item RUFFLED_TOFFY_APPLE = new FoodOnAStickItem(new Item.Settings().recipeRemainder(Items.STICK).group(ItemGroup.FOOD).maxCount(64).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).statusEffect(new StatusEffectInstance(StatusEffects.SLOW_FALLING, 300, 0),1f).alwaysEdible().build()));
	public static Item GOLDEN_TOFFY_APPLE = new FoodOnAStickItem(new Item.Settings().recipeRemainder(Items.STICK).group(ItemGroup.FOOD).maxCount(64).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).statusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, 300, 0),1f).alwaysEdible().build()));
	public static Item GREEN_TOFFY_APPLE = new FoodOnAStickItem(new Item.Settings().recipeRemainder(Items.STICK).group(ItemGroup.FOOD).maxCount(64).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).statusEffect(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 300, 0),1f).alwaysEdible().build()));
